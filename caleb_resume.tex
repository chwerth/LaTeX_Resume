...
\begin{itemize}
  \item Lead efforts to build test automation and software release infrastructure in Jenkins
  \item Provide new features, bug fixes, and customer support for MATLAB applications
\end{itemize}
...
\cvsubsection{The University of Alabama}[Tuscaloosa, AL]
